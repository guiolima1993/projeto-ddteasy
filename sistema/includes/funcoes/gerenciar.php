				...
				<?php
					...
					<?php
						...
						case "TELEFONE":
							?>    
							<?php if($_GET[1]=='denuncia'){     ?>
                            	<input name="<?php echo $i; ?>" id="HtmlInp<?php echo $i; ?>" value="<?php echo (($d == 0)?"":$Dados[$i]); ?>" type="<?php echo ((isset($v[4]) && $v[4] != NULL)?$v[4]:"text"); ?>" maxlength="<?php echo $v[2]; ?>" data-mask="(00) 0000-0000" placeholder="(00) 0000-0000" class="form-control <?php echo ((isset($v[3]) && $v[3] == "NOT NULL")?"req":""); ?>" readonly />
                                <?php echo ((isset($v[5]) && $v[5] != NULL)?'<br /><span class="label">'.$v[5].'</span>':""); ?>
                            <?php }else{    ?>
								 <input name="<?php echo $i; ?>" id="HtmlInp<?php echo $i; ?>" value="<?php echo (($d == 0)?"":$Dados[$i]); ?>" type="<?php echo ((isset($v[4]) && $v[4] != NULL)?$v[4]:"text"); ?>" maxlength="<?php echo $v[2]; ?>" data-mask="(00) 0000-0000" placeholder="(00) 0000-0000" class="form-control <?php echo ((isset($v[3]) && $v[3] == "NOT NULL")?"req":""); ?>" />
                                <?php echo ((isset($v[5]) && $v[5] != NULL)?'<br /><span class="label">'.$v[5].'</span>':""); ?>
                            <?php }   ?>
                            <?php
						break;
						...
						case "CELULAR":
							?>    
							<?php if($_GET[1]=='denuncia'){     ?>
                            	<input name="<?php echo $i; ?>" id="HtmlInp<?php echo $i; ?>" value="<?php echo (($d == 0)?"":$Dados[$i]); ?>" type="<?php echo ((isset($v[4]) && $v[4] != NULL)?$v[4]:"text"); ?>" maxlength="<?php echo $v[2]; ?>" data-mask="(00) 00000-0000" placeholder="(00) 00000-0000" class="form-control <?php echo ((isset($v[3]) && $v[3] == "NOT NULL")?"req":""); ?>" readonly />
                                <?php echo ((isset($v[5]) && $v[5] != NULL)?'<br /><span class="label">'.$v[5].'</span>':""); ?>
                            <?php }else{    ?>
								 <input name="<?php echo $i; ?>" id="HtmlInp<?php echo $i; ?>" value="<?php echo (($d == 0)?"":$Dados[$i]); ?>" type="<?php echo ((isset($v[4]) && $v[4] != NULL)?$v[4]:"text"); ?>" maxlength="<?php echo $v[2]; ?>" data-mask="(00) 00000-0000" placeholder="(00) 00000-0000" class="form-control <?php echo ((isset($v[3]) && $v[3] == "NOT NULL")?"req":""); ?>" />
                                <?php echo ((isset($v[5]) && $v[5] != NULL)?'<br /><span class="label">'.$v[5].'</span>':""); ?>
                            <?php }   ?>
                            <?php
						break;
