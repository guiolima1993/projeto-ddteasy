                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            if (data == 1) {
                                ...
                                if(t_id == "form-editar-servico") {
                                    swal({
                                        title: "Sucesso",
                                        text: data.message ? data.message : "Você acabou de editar o serviço!",
                                        icon: "success",
                                        confirmButtonText: "Ok",
                                    }).then((formEdited) => {
                                        
                                        window.location.href = "http://desenvolvimentomw.com.br/projetos_2021/ddteasy/dev/ddteasy-admin/servicos.php"
