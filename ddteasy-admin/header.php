      ...
      <nav class="navbar px-2 navbar-expand-xl">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a href="enviar-conteudo.php" class="nav-link">Conteúdo para Sellers</a>
            </li>
            <li class="nav-item active">
              <a class="nav-link" href="#">Dashboard</a>
            </li>
            <li class="nav-item">
              <a href="gestao-clientes.php" class="nav-link">Gestão de clientes</a>
            </li>
            <li class="nav-item">
              <a href="gestao-sellers.php" class="nav-link">Gestão de Sellers</a>
            </li>                       
            <li class="nav-item">
            ...
            <li class="nav-item">
              <a href="requisicoes/sair.php" class="nav-link">Sair</a>
            </li>
          </ul>
        </div>
